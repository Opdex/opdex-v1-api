...
{
    public class SelectApprovalEventsByTransactionIdQueryHandlerTests
    {
        private readonly Mock<IDbContext> _dbContext;
        private readonly SelectApprovalEventsByTransactionIdQueryHandler _handler;
        
        public SelectApprovalEventsByTransactionIdQueryHandlerTests()
        {
            var mapper = new MapperConfiguration(config => config.AddProfile(new CoreInfrastructureMapperProfile())).CreateMapper();
            
            _dbContext = new Mock<IDbContext>();
            _handler = new SelectApprovalEventsByTransactionIdQueryHandler(_dbContext.Object, mapper);
        }
