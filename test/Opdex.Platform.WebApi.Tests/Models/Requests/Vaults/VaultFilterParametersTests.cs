...
public class VaultGovernanceFilterParametersTests
{
    [Fact]
    public void DefaultPropertyValues()
    {
        // Arrange
        // Act
        var filters = new VaultGovernanceFilterParameters();
    ...
    {
        // Arrange
        var filters = new VaultGovernanceFilterParameters { EncodedCursor = "NOT_BASE_64_****" };
    ...
    {
        // Arrange
        var filters = new VaultGovernanceFilterParameters { EncodedCursor = "Tk9UX1ZBTElE" };
    ...
    {
        // Arrange
        var filters = new VaultGovernanceFilterParameters { EncodedCursor = "ZGlyZWN0aW9uOkRFU0M7bGltaXQ6NTtwYWdpbmc6Rm9yd2FyZDtwb2ludGVyOk13PT07" };
