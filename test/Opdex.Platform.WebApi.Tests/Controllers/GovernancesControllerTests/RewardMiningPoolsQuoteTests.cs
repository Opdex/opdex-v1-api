...
namespace Opdex.Platform.WebApi.Tests.Controllers.GovernancesControllerTests
{
    public class RewardMiningPoolsQuoteTests
    {
        ...
        public async Task RewardMiningPools_CreateRewardMiningPoolsTransactionQuoteCommand_Send()
        {
            ...
            Address governance = "PGZPZpB4iW4LHVEPMKehXfJ6u1yzNPDda3";
            ...
            // Act
            await _controller.RewardMiningPools(governance, requestBody, cancellationToken);

            // Assert
            _mediatorMock.Verify(callTo => callTo.Send(It.Is<CreateRewardMiningPoolsTransactionQuoteCommand>(query => query.Governance == governance
        ...
        public async Task RewardMiningPools_CreateRewardMiningPoolsTransactionQuoteCommandResponse_ReturnOk()
        {
            ...
            // Act
            var response = await _controller.RewardMiningPools(governance, requestBody, cancellationToken);
