...
namespace Opdex.Platform.WebApi.Tests.Controllers.MiningPoolsController
{
    public class CollectMiningRewardsQuoteTests
    {
        ...
        public CollectMiningRewardsQuoteTests()
        {
        ...
        [Fact]
        public async Task CollectMiningRewards_CreateCollectMiningRewardsTransactionQuoteCommand_Send()
        {
            // Arrange
            ...
            // Act
            await _controller.CollectMiningRewards(miningPool, cancellationToken);

            // Assert
            _mediatorMock.Verify(callTo => callTo.Send(It.Is<CreateCollectMiningRewardsTransactionQuoteCommand>(query => query.ContractAddress == miningPool
                                                                                                       && query.WalletAddress == walletAddress), cancellationToken), Times.Once);
        }

        [Fact]
        public async Task CollectMiningRewards_CreateCollectMiningRewardsTransactionQuoteCommandResponse_Map()
        {
            // Arrange
        ...
        [Fact]
        public async Task CollectMiningRewards_CreateCollectMiningRewardsTransactionQuoteCommandResponse_ReturnOk()
        {
            // Arrange
            ...
            // Act
            var response = await _controller.CollectMiningRewards(miningPool, cancellationToken);
