...
{
    public class CallCirrusGetAmountInStandardQuoteQueryHandlerTests
    {
        private readonly Mock<ISmartContractsModule> _smartContractModule;
        private readonly CallCirrusGetAmountInStandardQuoteQueryHandler _handler;

        public CallCirrusGetAmountInStandardQuoteQueryHandlerTests()
        {
            _smartContractModule = new Mock<ISmartContractsModule>();

            _handler = new CallCirrusGetAmountInStandardQuoteQueryHandler(_smartContractModule.Object);
        }
        ...
        {
            // Arrange
            var query = new CallCirrusGetAmountInStandardQuoteQuery(new Address("tMCT728cPmhexrrqqkErDbYAC9eA1wNGZA"),
            ...
            {
                new SmartContractMethodParameter(query.AmountOut),
