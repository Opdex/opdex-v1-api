...
namespace Opdex.Platform.Infrastructure.Tests.Data.Handlers.Governances
{
    public class PersistMiningGovernanceCommandHandlerTests
    {
        ...
        public async Task PersistsMiningGovernance_Success()
        {
            ...
            var miningGovernance = new MiningGovernance("PGZPZpB4iW4LHVEPMKehXfJ6u1yzNPDw7u", 1, 2, 4, 5, 12312323, 1);
        ...
        {
            var token = new MiningGovernance("PGZPZpB4iW4LHVEPMKehXfJ6u1yzNPDw7u", 1, 2, 4, 5, 12312323, 1);
