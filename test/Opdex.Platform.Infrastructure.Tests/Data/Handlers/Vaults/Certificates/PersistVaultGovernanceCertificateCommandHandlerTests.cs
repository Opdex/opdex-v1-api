...
public class PersistVaultCertificateCommandHandlerTests
{
    ...
    public PersistVaultCertificateCommandHandlerTests()
    {
        ...
        _handler = new PersistVaultCertificateCommandHandler(_dbContextMock.Object, Mock.Of<ILogger<PersistVaultCertificateCommandHandler>>(), _mapperMock.Object);
    }
    ...
    public async Task Insert_VaultCertificate_Success()
    {
        ...
        var command = new PersistVaultCertificateCommand(certificate);
