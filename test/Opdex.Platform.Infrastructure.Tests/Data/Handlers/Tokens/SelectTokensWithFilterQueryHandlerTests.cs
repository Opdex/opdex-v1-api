...
public class SelectTokensWithFilterQueryHandlerTests
{
    ...
    public async Task Handle_Filter_Tokens()
    {
        ...
        var cursor = new TokensCursor(null, tokens, TokenProvisionalFilter.All, TokenOrderByType.Default,
                                      SortDirectionType.ASC, 5, PagingDirection.Forward, default);
    ...
    {
        // Arrange
        var cursor = new TokensCursor(null, Enumerable.Empty<Address>(), filter, TokenOrderByType.Default,
                                      SortDirectionType.ASC, 5, PagingDirection.Forward, default);
    ...
    {
        // Arrange
        var cursor = new TokensCursor("BTC", Enumerable.Empty<Address>(), TokenProvisionalFilter.All, TokenOrderByType.Default,
                                      SortDirectionType.ASC, 5, PagingDirection.Forward, default);
