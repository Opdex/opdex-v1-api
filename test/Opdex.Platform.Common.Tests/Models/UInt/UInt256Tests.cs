...
{
    /// <summary>
    /// Borrowed and referencing https://github.com/stratisproject/Stratis.SmartContracts/blob/master/Stratis.SmartContracts.Tests/UInt256Tests.cs
    /// </summary>
    public class UInt256Tests
    {
        private readonly ITestOutputHelper _testOutputHelper;

        public UInt256Tests(ITestOutputHelper testOutputHelper)
        {
            _testOutputHelper = testOutputHelper;
        }

        [Fact]
        public void Creates_UInt256()
        {
            var test = new UInt256("876545678909876567890987");
            var test2 = new UInt256("876545678909876567890988");
