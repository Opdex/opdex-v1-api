...
public class GetMiningGovernancesWithFilterQueryHandlerTests
{
    ...
    public GetMiningGovernancesWithFilterQueryHandlerTests()
    {
        ...
        _handler = new GetMiningGovernancesWithFilterQueryHandler(_mediatorMock.Object, _assemblerMock.Object, new NullLogger<GetMiningGovernancesWithFilterQueryHandler>());
    }
    ...
    public async Task Handle_LessThanLimitPlusOneResults_RemoveZero()
    {
        ...
        // Assert
        dto.MiningGovernances.Count().Should().Be(miningGovernances.Length);
    }
    ...
    public async Task Handle_LimitPlusOneResultsPagingBackward_RemoveFirst()
    {
        ...
        dto.MiningGovernances.Count().Should().Be(miningGovernances.Length - 1);
    }
