...
namespace Opdex.Platform.Application.Tests.EntryHandlers.LiquidityPools
{
    public class CreateAddLiquidityTransactionQuoteCommandHandlerTests
    {
        ...
        const string MethodName = LiquidityPoolConstants.Methods.AddLiquidity;
        ...
        [InlineData("")]
        [InlineData("   ")]
        public void CreateAddLiquidityTransactionQuoteCommand_InvalidLiquidityPool_ThrowArgumentNullException(string liquidityPool)
        {
            // Arrange
        ...
        [InlineData("")]
        [InlineData("   ")]
        public void CreateAddLiquidityTransactionQuoteCommand_InvalidRecipient_ThrowArgumentNullException(string recipient)
        {
            // Arrange
            Address walletAddress = "PWcdTKU64jVFCDoHJgUKz633jsy1XTenAy";
            Address liquidityPool = "PBSH3FTVne6gKiSgVBL4NRTJ31QmGShjMy";
        ...
        [Fact]
        public void CreateAddLiquidityTransactionQuoteCommand_InvalidDeadline_ThrowArgumentOutOfRangeException()
        {
            // Arrange
            Address walletAddress = "PWcdTKU64jVFCDoHJgUKz633jsy1XTenAy";
            Address liquidityPool = "PBSH3FTVne6gKiSgVBL4NRTJ31QmGShjMy";
