...
namespace Opdex.Platform.Application.Tests.EntryHandlers.Addresses
{
    public class GetStakingPositionsWithFilterQueryHandlerTests
    {
        ...
        {
            // Arrange
            var cursor = new StakingPositionsCursor(Enumerable.Empty<string>(), false, SortDirectionType.ASC, 25, PagingDirection.Backward, 55);
        ...
        public async Task Handle_PositionsRetrieved_MapResults()
        {
            ...
            var position = new AddressStaking(5, 10, "PGZPZpB4iW4LHVEPMKehXfJ6u1yzNPDw7u", "10000000000", 500, 505);
        ...
        {
            // Arrange
            var cursor = new StakingPositionsCursor(Enumerable.Empty<string>(), false, SortDirectionType.ASC, 3, PagingDirection.Backward, 55);
            var request = new GetStakingPositionsWithFilterQuery("PHUzrtkLfffDZMd2v8QULRZvBCY5RwrrQK", cursor);

            var positions = new AddressStaking[]
            {
                new AddressStaking(5, 10, "PGZPZpB4iW4LHVEPMKehXfJ6u1yzNPDw7u", "10000000000", 500, 505),
                new AddressStaking(10, 10, "PAVV2c9Muk9Eu4wi8Fqdmm55ffzhAFPffV", "10000000000", 500, 505),
                new AddressStaking(15, 10, "PXResSytiRhJwNiD1DS9aZinPjEUvk8BuX", "10000000000", 500, 505)
            };
            _mediatorMock.Setup(callTo => callTo.Send(It.IsAny<RetrieveStakingPositionsWithFilterQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(positions);
        ...
        {
            // Arrange
            var cursor = new StakingPositionsCursor(Enumerable.Empty<string>(), false, SortDirectionType.ASC, 2, PagingDirection.Backward, 55);
            var request = new GetStakingPositionsWithFilterQuery("PHUzrtkLfffDZMd2v8QULRZvBCY5RwrrQK", cursor);
        ...
        {
            // Arrange
            var cursor = new StakingPositionsCursor(Enumerable.Empty<string>(), false, SortDirectionType.ASC, 2, PagingDirection.Forward, 55);
            var request = new GetStakingPositionsWithFilterQuery("PHUzrtkLfffDZMd2v8QULRZvBCY5RwrrQK", cursor);
        ...
        {
            // Arrange
            var cursor = new StakingPositionsCursor(Enumerable.Empty<string>(), false, SortDirectionType.ASC, 2, PagingDirection.Forward, 0);
            var request = new GetStakingPositionsWithFilterQuery("PHUzrtkLfffDZMd2v8QULRZvBCY5RwrrQK", cursor);
        ...
        {
            // Arrange
            var cursor = new StakingPositionsCursor(Enumerable.Empty<string>(), false, SortDirectionType.ASC, 2, PagingDirection.Forward, 50);
            var request = new GetStakingPositionsWithFilterQuery("PHUzrtkLfffDZMd2v8QULRZvBCY5RwrrQK", cursor);
        ...
        {
            // Arrange
            var cursor = new StakingPositionsCursor(Enumerable.Empty<string>(), false, SortDirectionType.ASC, 2, PagingDirection.Backward, 50);
            var request = new GetStakingPositionsWithFilterQuery("PHUzrtkLfffDZMd2v8QULRZvBCY5RwrrQK", cursor);
