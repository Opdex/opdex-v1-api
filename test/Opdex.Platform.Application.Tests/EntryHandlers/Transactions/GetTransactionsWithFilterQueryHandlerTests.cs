...
public class GetTransactionsWithFilterQueryHandlerTests
{
    ...
    public GetTransactionsWithFilterQueryHandlerTests()
    {
        ...
        _handler = new GetTransactionsWithFilterQueryHandler(_mediatorMock.Object, _assemblerMock.Object, new NullLogger<GetTransactionsWithFilterQueryHandler>());
    }
    ...
    public async Task Handle_TransactionsRetrieved_MapResults()
    {
        ...
        var transaction = new Transaction(5, new Sha256(5340958239), 500, 10000, "PGZPZpB4iW4LHVEPMKehXfJ6u1yzNPDw7u", "PAVV2c9Muk9Eu4wi8Fqdmm55ffzhAFPffV", true, null, null);
    ...
    public async Task Handle_LessThanLimitPlusOneResults_RemoveZero()
    {
        ...
        {
            new Transaction(5, new Sha256(5340958239), 500, 10000, "PGZPZpB4iW4LHVEPMKehXfJ6u1yzNPDw7u", "PAVV2c9Muk9Eu4wi8Fqdmm55ffzhAFPffV", true, null, null),
            new Transaction(10, new Sha256(5340958239), 505, 10000, "PXResSytiRhJwNiD1DS9aZinPjEUvk8BuX", "PAVV2c9Muk9Eu4wi8Fqdmm55ffzhAFPffV", true, null, null),
            new Transaction(15, new Sha256(5340958239), 510, 10000, "PAVV2c9Muk9Eu4wi8Fqdmm55ffzhAFPffV", "PGZPZpB4iW4LHVEPMKehXfJ6u1yzNPDw7u", true, null, null)
        };
        _mediatorMock.Setup(callTo => callTo.Send(It.IsAny<RetrieveTransactionsWithFilterQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(transactions);
