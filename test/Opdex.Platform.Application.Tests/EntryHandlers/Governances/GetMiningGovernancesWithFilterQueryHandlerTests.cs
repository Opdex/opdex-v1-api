...
namespace Opdex.Platform.Application.Tests.EntryHandlers.Governances
{
    public class GetMiningGovernancesWithFilterQueryHandlerTests
    {
        ...
        {
            // Arrange
            var cursor = new MiningGovernancesCursor("", SortDirectionType.ASC, 25, PagingDirection.Backward, 55);
        ...
        public async Task Handle_MiningGovernancesRetrieved_MapResults()
        {
            ...
            {
                new MiningGovernance(5, "PGZPZpB4iW4LHVEPMKehXfJ6u1yzNPDw7u", 10, 500000, 10000, 15, "10000000000", 500, 505),
                new MiningGovernance(10, "PAVV2c9Muk9Eu4wi8Fqdmm55ffzhAFPffV", 10, 500000, 10000, 15, "10000000000", 500, 505),
                new MiningGovernance(15, "P9vqymoKE6JbeLmnbDS9HsZ68QZf15ed71", 10, 500000, 10000, 15, "10000000000", 500, 505)
            };
        ...
        {
            // Arrange
            var cursor = new MiningGovernancesCursor("", SortDirectionType.ASC, 3, PagingDirection.Backward, 55);
            var request = new GetMiningGovernancesWithFilterQuery(cursor);
        ...
        {
            // Arrange
            var cursor = new MiningGovernancesCursor("", SortDirectionType.ASC, 2, PagingDirection.Backward, 55);
            var request = new GetMiningGovernancesWithFilterQuery(cursor);
        ...
        {
            // Arrange
            var cursor = new MiningGovernancesCursor("", SortDirectionType.ASC, 2, PagingDirection.Forward, 55);
            var request = new GetMiningGovernancesWithFilterQuery(cursor);
        ...
        {
            // Arrange
            var cursor = new MiningGovernancesCursor("", SortDirectionType.ASC, 2, PagingDirection.Forward, 0);
            var request = new GetMiningGovernancesWithFilterQuery(cursor);
        ...
        {
            // Arrange
            var cursor = new MiningGovernancesCursor("", SortDirectionType.ASC, 2, PagingDirection.Forward, 50);
            var request = new GetMiningGovernancesWithFilterQuery(cursor);
        ...
        {
            // Arrange
            var cursor = new MiningGovernancesCursor("", SortDirectionType.ASC, 2, PagingDirection.Backward, 50);
            var request = new GetMiningGovernancesWithFilterQuery(cursor);
