...
public class GetVaultProposalsWithFilterQueryHandlerTests
{
    ...
    public GetVaultProposalsWithFilterQueryHandlerTests()
    {
        ...
        _handler = new GetVaultProposalsWithFilterQueryHandler(_mediatorMock.Object, _assemblerMock.Object, new NullLogger<GetVaultProposalsWithFilterQueryHandler>());
    }
