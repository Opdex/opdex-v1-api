...
namespace Opdex.Platform.Application.Tests.EntryHandlers.Vaults.Pledges;
...
public class CreateRewindVaultProposalPledgesCommandHandlerTests
{
    ...
    [Fact]
    public async Task CreateRewindVaultProposalPledgesCommand_Sends_RetrieveVaultByIdQuery()
    {
        // Arrange
        const ulong rewindHeight = 10;
