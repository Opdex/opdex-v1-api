    ...
    public class CreateWalletSetVaultOwnerCommandHandlerTests
    {
        ...
        public async Task Handle_MediatorMakeSetVaultOwnerCommand_Send()
        {
            ...
            _mediatorMock.Verify(callTo => callTo.Send(
                It.Is<MakeWalletSetVaultOwnerCommand>(command => command.WalletAddress == walletAddress
                                                        && command.Vault == vault
                                                        && command.Owner == owner),
        ...
        public async Task Handle_MediatorMakeSetVaultOwnerCommand_Return()
        {
            ...
            _mediatorMock.Setup(callTo => callTo.Send(It.IsAny<MakeWalletSetVaultOwnerCommand>(), It.IsAny<CancellationToken>()))
