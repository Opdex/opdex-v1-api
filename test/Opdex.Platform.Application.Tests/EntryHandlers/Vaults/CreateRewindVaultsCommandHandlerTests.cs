...
public class CreateRewindVaultsCommandHandlerTests
{
    ...
    public async Task CreateRewindVaultsCommand_Sends_MakeVaultCommand()
    {
        ...
        {
            new Vault(1, "PXXNMivLgqqART1GLsMroh6zwmH1iU9Ejm", 2, Address.Empty, "PT1GLsMroh6zXXNMU9EjmivLgqqARwmH1i", 3ul, 4, 5, 6),
            new Vault(2, "PXXNsMroh6zwmH1iU9EjmMivLgqqART1GL", 3, Address.Empty, "PivLgqqARwmH1iT1GLsMroh6zXXNMU9Ejm", 4ul, 5, 6, 7),
            new Vault(3, "PXXroh6zwmH1iU9NMivLgqqART1GLsMEjm", 4, Address.Empty, "P6zXXNMU9EjmivLgqqARwmH1iT1GLsMroh", 5ul, 6, 7, 8),
            new Vault(4, "Proh6zwmH1iU9EjmXXNMivLgqqART1GLsM", 5, Address.Empty, "PTivLgqqARwmH1i1GLsMroh6zXXNMU9Ejm", 6ul, 7, 8, 9)
        };
