...
namespace Opdex.Platform.Application.Tests.EntryHandlers.Routers
{
    public class GetSwapAmountInQueryHandlerTests
    {
        ...
        public async Task SingleHop_RetrieveLiquidityPoolReserves_Once()
        {
            ...
            var request = new GetSwapAmountInQuery(new Address("PSxx8BBVDpB5qHKmm7RGLDVaEL8p9NWbZW"), Address.Cirrus,
                                                   new Address("PCiNwuLQemjMk63A6r5mS2Ma9Kskki6HZK"), FixedDecimal.Parse("34209.34821118"));
        ...
        public async Task MultiHop_RetrieveLiquidityPoolReserves_Twice()
        {
            ...
            var request = new GetSwapAmountInQuery(new Address("PSxx8BBVDpB5qHKmm7RGLDVaEL8p9NWbZW"), new Address("PNvzq4pxJ5v3pp9kDaZyifKNspGD79E4qM"),
                                                   new Address("PCiNwuLQemjMk63A6r5mS2Ma9Kskki6HZK"), FixedDecimal.Parse("34209.34821118"));
            var cancellationToken = new CancellationTokenSource().Token;
