...
namespace Opdex.Platform.Application.Tests.Handlers.Markets
{
    public class MakeMarketCommandHandlerTests
    {
        ...
        {
            // Arrange
            var market = new Market(1, "PH1iT1GLsMroh6zXXNMU9EjmivLgqqARwm", 2, 3, "PMU9EjmivLgqqARwmH1iT1GLsMroh6zXXN", true,
        ...
        public async Task MakeMarketCommand_Sends_RetrieveMarketContractSummaryByAddressQuery(bool refreshOwner,
                                                                                              bool expected)
        {
            // Arrange
            const ulong blockHeight = 20;
            var stakingTokenId = refreshOwner ? 0 : 1;
            var market = new Market(1, "PH1iT1GLsMroh6zXXNMU9EjmivLgqqARwm", 2, stakingTokenId, "PMU9EjmivLgqqARwmH1iT1GLsMroh6zXXN", true,
                                        false, false, 3, true, 10, 11);
