...
public class RetrieveTransactionByHashQueryHandlerTests
{
    ...
    {
        // Arrange
        var request = new RetrieveTransactionByHashQuery(Sha256.Parse("4d03447aba5e25c5c647a18a175cd36d0c23bcc2c8cb9d0288c119da06f3b2fd"));
    ...
    public async Task RetrieveTransaction_Returns()
    {
        ...
        var transaction = new Transaction(1, Sha256.Parse("4d03447aba5e25c5c647a18a175cd36d0c23bcc2c8cb9d0288c119da06f3b2fd"), 2, 3,
                                          "PAXxsvwuwGrJg1XnNCA8Swtpynzj2G8Eca", "PTbuFnGyvo93toQyFdmU1J5WGYBWGUnML3",
                                          true, null, "PBJPuCXfcNKdN28FQf5uJYUcmAsqAEgUXj");
