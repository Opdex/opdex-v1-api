...
public class TokensApplicationMapperProfileTests : PlatformApplicationMapperProfileTests
{
    ...
    {
        // Arrange
        var tokenSnapshot = new TokenSnapshot(5, 10, 15, new Ohlc<decimal>(15.0m, 20.0m, 10.5m, 12.0m), SnapshotType.Daily, DateTime.UtcNow.AddDays(-1), DateTime.UtcNow, DateTime.UtcNow);
