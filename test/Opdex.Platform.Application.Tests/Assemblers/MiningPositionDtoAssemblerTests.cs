...
namespace Opdex.Platform.Application.Tests.Assemblers
{
    public class MiningPositionDtoAssemblerTests
    {
        ...
        {
            // Arrange
            var addressMining = new AddressMining(5, 10, "PMU9EjmivLgqqARwmH1iT1GLsMroh6zXXN", "50000000", 500, 505);
        ...
        public async Task Assemble_RetrieveLiquidityPoolByIdQuery_Send()
        {
            ...
            var miningPool = new MiningPool(10, 5, "PX2J4s4UHLfwZbDRJSvPoskKD25xQBHWYi", "5000", "1000", 500000, 500, 505);
        ...
        {
            // Arrange
            var addressMining = new AddressMining(5, 10, "PMU9EjmivLgqqARwmH1iT1GLsMroh6zXXN", "5000000000", 500, 505);
            ...
            var token = new Token(15, "PWcdTKU64jVFCDoHJgUKz633jsy1XTenAy", true, "wBTC/CRS OLPT", "OLPT", 8, 8, "10000000000000000000", 500, 505);
