...
public class StakingPositionDtoAssemblerTests
{
    ...
    public async Task Assemble_HappyPath_Map()
    {
        ...
        var token = new Token(50, "PWcdTKU64jVFCDoHJgUKz633jsy1XTenAy", true, "Governance Token", "GOV", 8, 8, UInt256.Parse("10000000000000000000"), new TokenSummary(5, 10, 50), 500, 505);
