...
{
    public class CallCirrusGetMiningPoolByTokenQueryHandler : IRequestHandler<CallCirrusGetMiningPoolByTokenQuery, Address>
    {
        ...
        public async Task<Address> Handle(CallCirrusGetMiningPoolByTokenQuery request, CancellationToken cancellationToken)
        {
            ...
            return response.DeserializeValue<Address>();
        }
    }
}
