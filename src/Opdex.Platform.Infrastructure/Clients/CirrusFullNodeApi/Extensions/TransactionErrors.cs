...
namespace Opdex.Platform.Infrastructure.Clients.CirrusFullNodeApi.Extensions
{
    public static class TransactionErrors
    {
        ...
        private const string RouterAddLiquidity = "OpdexRouter.AddLiquidity(Address token, UInt256 amountSrcDesired, ulong amountCrsMin, UInt256 amountSrcMin, Address to, ulong deadline)";
        private const string RouterRemoveLiquidity = "OpdexRouter.RemoveLiquidity(Address token, UInt256 liquidity, ulong amountCrsMin, UInt256 amountSrcMin, Address to, ulong deadline)";
        private const string RouterSwapExactCrsForSrc = "OpdexRouter.SwapExactCrsForSrc(UInt256 amountSrcOutMin, Address token, Address to, ulong deadline)";
        private const string RouterSwapSrcForExactCrs = "OpdexRouter.SwapSrcForExactCrs(ulong amountCrsOut, UInt256 amountSrcInMax, Address token, Address to, ulong deadline)";
        private const string RouterSwapExactSrcForCrs = "OpdexRouter.SwapExactSrcForCrs(UInt256 amountSrcIn, ulong amountCrsOutMin, Address token, Address to, ulong deadline)";
        private const string RouterSwapCrsForExactSrc = "OpdexRouter.SwapCrsForExactSrc(UInt256 amountSrcOut, Address token, Address to, ulong deadline)";
        private const string RouterSwapSrcForExactSrc = "OpdexRouter.SwapSrcForExactSrc(UInt256 amountSrcInMax, Address tokenIn, UInt256 amountSrcOut, Address tokenOut, Address to, ulong deadline)";
        private const string RouterSwapExactSrcForSrc = "OpdexRouter.SwapExactSrcForSrc(UInt256 amountSrcIn, Address tokenIn, UInt256 amountSrcOutMin, Address tokenOut, Address to, ulong deadline)";
        ...
        private const string StandardPoolSwap = "OpdexStandardPool.Swap(ulong amountCrsOut, UInt256 amountSrcOut, Address to, byte[] data)";
        ...
        private const string StakingPoolSwap = "OpdexStakingPool.Swap(ulong amountCrsOut, UInt256 amountSrcOut, Address to, byte[] data)";
        ...
        public static bool TryParseFriendlyErrorMessage(string input, out string friendlyErrorMessage)
        {
