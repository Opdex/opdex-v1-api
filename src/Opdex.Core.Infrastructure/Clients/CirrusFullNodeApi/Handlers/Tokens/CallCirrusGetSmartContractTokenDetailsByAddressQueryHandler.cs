...
namespace Opdex.Core.Infrastructure.Clients.CirrusFullNodeApi.Handlers.Tokens
{
    public class CallCirrusGetSmartContractTokenDetailsByAddressQueryHandler
        : IRequestHandler<CallCirrusGetSmartContractTokenDetailsByAddressQuery, Token>
    {
        ...
        public async Task<Token> Handle(CallCirrusGetSmartContractTokenDetailsByAddressQuery request, CancellationToken cancellationToken)
        {
