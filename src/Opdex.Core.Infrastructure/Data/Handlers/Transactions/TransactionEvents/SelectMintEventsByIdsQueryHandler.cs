...
{
    public class SelectMintEventsByIdsQueryHandler : IRequestHandler<SelectMintEventsByIdsQuery, IEnumerable<MintEvent>>
    {
        ...
        public SelectMintEventsByIdsQueryHandler(IDbContext context, IMapper mapper)
        {
            _context = context ?? throw new ArgumentNullException(nameof(context));
            _mapper = mapper ?? throw new ArgumentNullException(nameof(mapper));
        }

        public async Task<IEnumerable<MintEvent>> Handle(SelectMintEventsByIdsQuery request, CancellationToken cancellationTransaction)
        {
