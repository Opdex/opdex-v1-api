...
{
    public class SelectSyncEventsByIdsQueryHandler : IRequestHandler<SelectSyncEventsByIdsQuery, IEnumerable<SyncEvent>>
    {
        ...
        public SelectSyncEventsByIdsQueryHandler(IDbContext context, IMapper mapper)
        {
            _context = context ?? throw new ArgumentNullException(nameof(context));
            _mapper = mapper ?? throw new ArgumentNullException(nameof(mapper));
        }

        public async Task<IEnumerable<SyncEvent>> Handle(SelectSyncEventsByIdsQuery request, CancellationToken cancellationTransaction)
        {
