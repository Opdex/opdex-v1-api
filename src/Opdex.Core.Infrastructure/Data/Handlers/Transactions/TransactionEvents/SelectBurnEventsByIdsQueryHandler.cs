...
{
    public class SelectBurnEventsByIdsQueryHandler : IRequestHandler<SelectBurnEventsByIdsQuery, IEnumerable<BurnEvent>>
    {
        ...
        public SelectBurnEventsByIdsQueryHandler(IDbContext context, IMapper mapper)
        {
            _context = context ?? throw new ArgumentNullException(nameof(context));
            _mapper = mapper ?? throw new ArgumentNullException(nameof(mapper));
        }

        public async Task<IEnumerable<BurnEvent>> Handle(SelectBurnEventsByIdsQuery request, CancellationToken cancellationTransaction)
        {
