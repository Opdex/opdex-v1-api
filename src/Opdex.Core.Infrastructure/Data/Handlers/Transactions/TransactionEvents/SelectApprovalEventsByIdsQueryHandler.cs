...
{
    public class SelectApprovalEventsByIdsQueryHandler : IRequestHandler<SelectApprovalEventsByIdsQuery, IEnumerable<ApprovalEvent>>
    {
        ...
        public SelectApprovalEventsByIdsQueryHandler(IDbContext context, IMapper mapper)
        {
            _context = context ?? throw new ArgumentNullException(nameof(context));
            _mapper = mapper ?? throw new ArgumentNullException(nameof(mapper));
        }

        public async Task<IEnumerable<ApprovalEvent>> Handle(SelectApprovalEventsByIdsQuery request, CancellationToken cancellationTransaction)
        {
