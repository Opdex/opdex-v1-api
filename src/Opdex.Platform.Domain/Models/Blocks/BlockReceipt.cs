...
public class BlockReceipt
{
    public BlockReceipt(Sha256 hash, ulong height, DateTime time, DateTime medianTime, Sha256? previousBlockHash, Sha256? nextBlockHash,
                        Sha256 merkleRoot, IEnumerable<Sha256> smartContractCallTxHashes)
    {
        if (height < 1)
        {
        ...
        SmartContractCallTxHashes = smartContractCallTxHashes;
    }
    ...
    public IEnumerable<Sha256> SmartContractCallTxHashes { get; }
