...
{
    public class NewVaultCertificate : BlockAudit
    {
        public NewVaultCertificate(ulong vaultId, Address owner, UInt256 amount, ulong vestedBlock, ulong createdBlock) : base(createdBlock)
        {
            if (vaultId < 1)
            {
        ...
        public NewVaultCertificate(ulong id, ulong vaultId, Address owner, UInt256 amount, ulong vestedBlock, bool redeemed, bool revoked, ulong createdBlock, ulong modifiedBlock)
