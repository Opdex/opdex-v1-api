...
{
    public class IndexLatestBlocksCommandHandler : IRequestHandler<IndexLatestBlocksCommand, Unit>
    {
        private readonly IMediator _mediator;
        private readonly ILogger<IndexLatestBlocksCommandHandler> _logger;

        public IndexLatestBlocksCommandHandler(IMediator mediator, ILogger<IndexLatestBlocksCommandHandler> logger)
        {
            _mediator = mediator ?? throw new ArgumentNullException(nameof(mediator));
            _logger = logger ?? throw new ArgumentNullException(nameof(logger));
        }

        public async Task<Unit> Handle(IndexLatestBlocksCommand request, CancellationToken cancellationToken)
        {
