...
{
    public class ProcessChangeMarketLogCommandHandler : IRequestHandler<ProcessChangeMarketLogCommand, bool>
    {
        private readonly IMediator _mediator;
        private readonly ILogger<ProcessChangeMarketLogCommandHandler> _logger;

        public ProcessChangeMarketLogCommandHandler(IMediator mediator, ILogger<ProcessChangeMarketLogCommandHandler> logger)
        {
