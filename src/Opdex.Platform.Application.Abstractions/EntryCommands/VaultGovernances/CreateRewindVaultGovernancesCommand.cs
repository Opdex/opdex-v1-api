...
/// <summary>
/// Create rewind vault governances command to refresh vault data based at a certain block height.
/// </summary>
public class CreateRewindVaultGovernancesCommand : IRequest<bool>
{
    /// <summary>
    /// Constructor to initialize the create rewind vault governances command.
    /// </summary>
