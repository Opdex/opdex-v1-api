...
{
    public class ProcessRevokeVaultCertificateCommand : CreateWalletTransactionCommand
    {
        public ProcessRevokeVaultCertificateCommand(string walletAddress, string vault, string holder) : base(walletAddress)
        {
