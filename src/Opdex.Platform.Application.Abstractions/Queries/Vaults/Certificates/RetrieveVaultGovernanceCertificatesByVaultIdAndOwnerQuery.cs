...
/// </summary>
public class RetrieveVaultCertificatesByVaultIdAndOwnerQuery : IRequest<IEnumerable<VaultCertificate>>
{
    /// <summary>
    ...
    public RetrieveVaultCertificatesByVaultIdAndOwnerQuery(ulong vaultId, Address owner)
    {
