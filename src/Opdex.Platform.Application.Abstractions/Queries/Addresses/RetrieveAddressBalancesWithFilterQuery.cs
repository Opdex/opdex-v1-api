...
{
    public class RetrieveAddressBalancesWithFilterQuery : IRequest<List<AddressBalance>>
    {
        public RetrieveAddressBalancesWithFilterQuery(string wallet, IEnumerable<string> tokens, bool includeLpTokens, bool includeZeroBalances,
