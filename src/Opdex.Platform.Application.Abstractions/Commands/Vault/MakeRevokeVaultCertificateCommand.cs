...
{
    public class MakeRevokeVaultCertificateCommand : MakeWalletTransactionCommand
    {
        public MakeRevokeVaultCertificateCommand(string walletAddress, string vault, string holder) : base(walletAddress)
        {
