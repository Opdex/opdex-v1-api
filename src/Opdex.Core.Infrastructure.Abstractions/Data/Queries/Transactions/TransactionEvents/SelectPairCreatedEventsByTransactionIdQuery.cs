...
{
    public class SelectPairCreatedEventsByTransactionIdQuery : IRequest<IEnumerable<PairCreatedEvent>>
    {
        public SelectPairCreatedEventsByTransactionIdQuery(IEnumerable<TransactionEventSummary> txEvents)
        {
