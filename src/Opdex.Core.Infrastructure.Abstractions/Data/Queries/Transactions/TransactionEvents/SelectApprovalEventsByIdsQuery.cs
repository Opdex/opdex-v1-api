...
{
    public class SelectApprovalEventsByIdsQuery : IRequest<IEnumerable<ApprovalEvent>>
    {
        public SelectApprovalEventsByIdsQuery(IEnumerable<TransactionEventSummary> txEvents)
        {
