...
{
    public class SelectBurnEventsByTransactionIdQuery : IRequest<IEnumerable<BurnEvent>>
    {
        public SelectBurnEventsByTransactionIdQuery(IEnumerable<TransactionEventSummary> txEvents)
        {
