...
{
    public class SelectTransferEventsByIdsQuery : IRequest<IEnumerable<TransferEvent>>
    {
        public SelectTransferEventsByIdsQuery(IEnumerable<TransactionEventSummary> txEvents)
        {
