...
{
    public class SelectPoolCreatedEventsByIdsQuery : IRequest<IEnumerable<PoolCreatedEvent>>
    {
        public SelectPoolCreatedEventsByIdsQuery(IEnumerable<TransactionEventSummary> txEvents)
        {
