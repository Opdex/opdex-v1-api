...
{
    public class SelectReservesLogsByIdsQuery : IRequest<IEnumerable<ReservesLog>>
    {
        public SelectReservesLogsByIdsQuery(IEnumerable<TransactionLogSummary> txLogs)
        {
