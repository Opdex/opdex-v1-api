...
{
    public class SelectTransferLogsByIdsQuery : IRequest<IEnumerable<TransferLog>>
    {
        public SelectTransferLogsByIdsQuery(IEnumerable<TransactionLogSummary> txLogs)
        {
