...
{
    public class SelectLiquidityPoolCreatedLogsByIdsQuery : IRequest<IEnumerable<LiquidityPoolCreatedLog>>
    {
        public SelectLiquidityPoolCreatedLogsByIdsQuery(IEnumerable<TransactionLogSummary> txLogs)
        {
