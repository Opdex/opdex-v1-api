...
{
    public class MiningGovernancesCursor : Cursor<ulong>
    {
        public MiningGovernancesCursor(Address minedToken, SortDirectionType sortDirection, uint limit, PagingDirection pagingDirection, ulong pointer)
        ...
        /// <summary>
        /// Filter for a particular mined token
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"minedToken:{MinedToken};direction:{SortDirection};limit:{Limit};paging:{PagingDirection};pointer:{encodedPointer};";
        }
        ...
        public override Cursor<ulong> Turn(PagingDirection direction, ulong pointer)
        {
            ...
            return new MiningGovernancesCursor(MinedToken, SortDirection, Limit, direction, pointer);
        }
        ...
        public static bool TryParse(string raw, out MiningGovernancesCursor cursor)
        {
            cursor = null;
            ...
            try
            {
                cursor = new MiningGovernancesCursor(minedToken, direction, limit, paging, pointer);
            }
            catch (Exception)
            {
                return false;
