...
{
    public class MiningGovernancesCursor : Cursor<long>
    {
        public MiningGovernancesCursor(Address minedToken, SortDirectionType sortDirection, uint limit, PagingDirection pagingDirection, long pointer)
