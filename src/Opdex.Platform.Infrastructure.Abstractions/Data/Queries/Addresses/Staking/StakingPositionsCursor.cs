...
public class StakingPositionsCursor : Cursor<ulong>
{
    public StakingPositionsCursor(IEnumerable<Address> liquidityPools, bool includeZeroAmounts, SortDirectionType sortDirection, uint limit, PagingDirection pagingDirection, ulong pointer)
