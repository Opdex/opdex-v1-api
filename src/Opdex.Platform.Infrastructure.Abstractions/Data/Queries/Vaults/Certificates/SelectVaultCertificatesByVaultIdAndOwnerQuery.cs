...
/// </summary>
public class SelectVaultCertificatesByVaultIdAndOwnerQuery : IRequest<IEnumerable<VaultCertificate>>
{
    /// <summary>
    ...
    public SelectVaultCertificatesByVaultIdAndOwnerQuery(ulong vaultId, Address owner)
    {
