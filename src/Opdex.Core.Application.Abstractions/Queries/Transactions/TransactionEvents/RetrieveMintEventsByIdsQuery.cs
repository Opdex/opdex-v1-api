...
{
    public class RetrieveMintEventsByIdsQuery : IRequest<IEnumerable<MintEvent>>
    {
        public RetrieveMintEventsByIdsQuery(IEnumerable<TransactionEventSummary> txEvents)
        {
