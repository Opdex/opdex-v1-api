...
{
    public class RetrieveBurnEventsByIdsQuery : IRequest<IEnumerable<BurnEvent>>
    {
        public RetrieveBurnEventsByIdsQuery(IEnumerable<TransactionEventSummary> txEvents)
        {
