...
{
    public class RetrieveSwapEventsByIdsQuery : IRequest<IEnumerable<SwapEvent>>
    {
        public RetrieveSwapEventsByIdsQuery(IEnumerable<TransactionEventSummary> txEvents)
        {
