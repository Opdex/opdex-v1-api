...
{
    public class RetrieveTransferEventsByIdsQuery: IRequest<IEnumerable<TransferEvent>>
    {
        public RetrieveTransferEventsByIdsQuery(IEnumerable<TransactionEventSummary> txEvents)
        {
