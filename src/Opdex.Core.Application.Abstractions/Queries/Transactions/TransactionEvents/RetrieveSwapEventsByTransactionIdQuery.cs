...
{
    public class RetrieveSwapEventsByTransactionIdQuery : IRequest<IEnumerable<SwapEvent>>
    {
        public RetrieveSwapEventsByTransactionIdQuery(IEnumerable<TransactionEventSummary> txEvents)
        {
