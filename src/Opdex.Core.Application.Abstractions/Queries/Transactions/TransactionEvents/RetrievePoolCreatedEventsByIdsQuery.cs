...
{
    public class RetrievePoolCreatedEventsByIdsQuery : IRequest<IEnumerable<PoolCreatedEvent>>
    {
        public RetrievePoolCreatedEventsByIdsQuery(IEnumerable<TransactionEventSummary> txEvents)
        {
