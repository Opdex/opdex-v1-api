...
{
    public class RetrieveSyncEventsByIdsQuery: IRequest<IEnumerable<SyncEvent>>
    {
        public RetrieveSyncEventsByIdsQuery(IEnumerable<TransactionEventSummary> txEvents)
        {
