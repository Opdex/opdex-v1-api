...
{
    public class RetrieveTransferLogsByIdsQuery: IRequest<IEnumerable<TransferLog>>
    {
        public RetrieveTransferLogsByIdsQuery(IEnumerable<TransactionLogSummary> txLogs)
        {
