...
{
    public class RetrieveLiquidityPoolCreatedLogsByIdsQuery : IRequest<IEnumerable<LiquidityPoolCreatedLog>>
    {
        public RetrieveLiquidityPoolCreatedLogsByIdsQuery(IEnumerable<TransactionLogSummary> txLogs)
        {
