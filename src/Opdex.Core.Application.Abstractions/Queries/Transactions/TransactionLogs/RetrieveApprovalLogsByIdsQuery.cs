...
{
    public class RetrieveApprovalLogsByIdsQuery : IRequest<IEnumerable<ApprovalLog>>
    {
        public RetrieveApprovalLogsByIdsQuery(IEnumerable<TransactionLogSummary> txLogs)
        {
