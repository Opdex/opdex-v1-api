...
{
    public class RetrieveReservesLogsByIdsQuery: IRequest<IEnumerable<ReservesLog>>
    {
        public RetrieveReservesLogsByIdsQuery(IEnumerable<TransactionLogSummary> txLogs)
        {
